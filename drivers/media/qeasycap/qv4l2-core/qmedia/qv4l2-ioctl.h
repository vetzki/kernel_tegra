...
extern const char *qv4l2_norm_to_name(v4l2_std_id id);
extern void qv4l2_video_std_frame_period(int id, struct v4l2_fract *frameperiod);
extern int qv4l2_video_std_construct(struct v4l2_standard *vs,
				    int id, const char *name);
/* Prints the ioctl in a human-readable format. If prefix != NULL,
   then do printk(KERN_DEBUG "%s: ", prefix) first. */
extern void qv4l_printk_ioctl(const char *prefix, unsigned int cmd);
...
extern const char *qv4l2_field_names[];
extern const char *qv4l2_type_names[];
...
extern long qvideo_usercopy(struct file *file, unsigned int cmd,
				unsigned long arg, v4l2_kioctl func);

/* Standard handlers for V4L ioctl's */
extern long qvideo_ioctl2(struct file *file,
