...
#include "../qv4l2-core/qmedia/qv4l2-ctrls.h"
...
static int saa711x_log_status(struct v4l2_subdev *sd)
{
	...
	qv4l2_ctrl_handler_log_status(&state->hdl, sd->name);
	return 0;
}
...
static const struct v4l2_subdev_core_ops saa711x_core_ops = {
	...
	.g_ext_ctrls = qv4l2_subdev_g_ext_ctrls,
	.try_ext_ctrls = qv4l2_subdev_try_ext_ctrls,
	.s_ext_ctrls = qv4l2_subdev_s_ext_ctrls,
	.g_ctrl = qv4l2_subdev_g_ctrl,
	.s_ctrl = qv4l2_subdev_s_ctrl,
	.queryctrl = qv4l2_subdev_queryctrl,
	.querymenu = qv4l2_subdev_querymenu,
	.s_std = saa711x_s_std,
	.reset = saa711x_reset,
			 ...
			 const struct i2c_device_id *id)
{
	...
	if (state == NULL)
		return -ENOMEM;
	sd = &state->sd;
	qv4l2_i2c_subdev_init(sd, client, &saa711x_ops);
	...
	qv4l2_ctrl_new_std(hdl, &saa711x_ctrl_ops,
	...
	state->agc = qv4l2_ctrl_new_std(hdl, &saa711x_ctrl_ops,
			V4L2_CID_CHROMA_AGC, 0, 1, 1, 1);
	state->gain = qv4l2_ctrl_new_std(hdl, &saa711x_ctrl_ops,
			V4L2_CID_CHROMA_GAIN, 0, 127, 1, 40);
	sd->ctrl_handler = hdl;
	if (hdl->error) {
		int err = hdl->error;

		qv4l2_ctrl_handler_free(hdl);
		return err;
	}
	qv4l2_ctrl_auto_cluster(2, &state->agc, 0, true);
...
static int saa711x_remove(struct i2c_client *client)
{
	...
	qv4l2_ctrl_handler_free(sd->ctrl_handler);
	return 0;
}
