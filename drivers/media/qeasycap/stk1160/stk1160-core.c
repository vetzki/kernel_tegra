		...
		const struct usb_device_id *id)
{
	...
	rc = qv4l2_device_register(dev->dev, &dev->v4l2_dev);
	if (rc) {
		stk1160_err("qv4l2_device_register failed (%d)\n", rc);
		goto free_ctrl;
	}
	 ...
	 */
	dev->sd_saa7115 = qv4l2_i2c_new_subdev(&dev->v4l2_dev, &dev->i2c_adap,
...
//!!!!!!!!!!1module_usb_driver(stk1160_usb_driver);
